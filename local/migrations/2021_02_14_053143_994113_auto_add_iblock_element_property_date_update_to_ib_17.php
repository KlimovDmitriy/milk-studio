...
class AutoAddIblockElementPropertyDateUpdateToIb1720210214053143994113 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    public function up()
    {
        $fields = array (
  'ID' => 0,
  'NAME' => 'Дата обновления заработка',
  'SORT' => 500,
  'CODE' => 'DATE_UPDATE',
  'MULTIPLE' => 'N',
  'IS_REQUIRED' => 'N',
  ...
  array (
    ...
    {
        $id = $this->getIblockPropIdByCode('DATE_UPDATE', 17);
